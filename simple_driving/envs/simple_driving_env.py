...
from simple_driving.resources.box import Box
...
class SimpleDrivingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # reward = min(self.prev_dist_to_goal - dist_to_goal, 0)
        reward = -dist_to_goal
    ...
    def reset(self):
        ...
        self.box_object = Box(self._p,self.box)
        self.box2_object = Box(self._p,self.box2)
